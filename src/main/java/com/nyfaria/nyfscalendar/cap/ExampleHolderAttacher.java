package com.nyfaria.nyfscalendar.cap;
...
@Mod.EventBusSubscriber(modid = NyfsCalendar.MODID)
public class ExampleHolderAttacher extends CapabilityAttacher {
    ...
    public static final ResourceLocation EXAMPLE_RL = new ResourceLocation(NyfsCalendar.MODID, "example");
