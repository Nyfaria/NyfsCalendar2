package com.nyfaria.nyfscalendar.config;
...
public class NCConfig {
    ...
    private NCConfig(ForgeConfigSpec.Builder builder){
        ...
        this.startYear = builder.comment("What Year do you want your World to Start in?").defineInRange("startYear", 2022 , -9999, 9999);
        builder.comment("#Everything Below this Line is NYI");
        ...
        this.customMonthNames = builder.comment("List of Custom Month Names").defineList("customMonthNames", Arrays.asList("January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"),o -> true);
